...
def _dependency_graph_image(modules, changed, direct, indirect):
    ...
    for name, (x, y) in pos.items():
        ...
        ax.scatter([x], [y], s=520, c=fill, edgecolors=edge,
...
def build_pdf_report(report):
    ...
    # Dependency graph
    graph_img = Image(
        _dependency_graph_image(modules, changed, set(direct), set(indirect)),
